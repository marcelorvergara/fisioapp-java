...
public class RelatorioEntradasMensal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGastos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fechar.png"))); // NOI18N
        btnGastos.setText("Fechar");
        ...
        jDesktopPane1.setLayer(btnGastos, javax.swing.JLayeredPane.DEFAULT_LAYER);
    ...
    private void initGrafico() {
        ...
        ApiFuture<QuerySnapshot> future
                = fbc.FirebaseInt().collection("entradas")
        ...
        try {
            ...
            Logger.getLogger(RelatorioEntradasMensal.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        //criação do gráfico
        JFreeChart chart = ChartFactory.createBarChart("Entradas", "Mês", "Valor rm R$",
